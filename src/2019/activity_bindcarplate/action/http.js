    ...
    axios({
      ...
      if (data.error) {
        if (data.error.code === 401) { // token失效
          ...
          let fromType = getHref.getQuery('from')
          ...
          axios({
            ...
            if (res.error) {
              ...
              localStorage.clear()
              if (beforehref === '#/oillist') {
                location.href = isTest ? `https://test.m.cheyuu.com/html/bindcarplate/index.html#/oillist?v=${timestamp}` : `https://m.cheyuu.com/html/bindcarplate/index.html#/oillist?v=${timestamp}`
              } else {
                location.href = isTest ? `https://test.m.cheyuu.com/html/bindcarplate/index.html#/?from=${fromType}&v=${timestamp}` : `https://m.cheyuu.com/html/bindcarplate/index.html#/?from=${fromType}&v=${timestamp}`
              }
            } else {
