...
const baseApi = isTest ? 'https://test.p.cheyuu.com' : 'https://p.cheyuu.com';
        ...
        if (data.error.code === 401) { // token失效
          ...
          axios({
            ...
            if (res.error) {
              ...
              localStorage.clear()
              if (beforehref === '#/details') {
                location.href = isTest ? `https://test.m.cheyuu.com/html/washcar/index.html#/details?id=${ID}` : `https://m.cheyuu.com/html/washcar/index.html#/details?id=${ID}`
              } else {
                location.href = isTest ? 'https://test.p.cheyuu.com/html/washcar/index.html' : '//p.cheyuu.com/html/washcar/index.html'
              }
            } else {
