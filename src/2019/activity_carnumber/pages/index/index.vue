<template>
  <div class="container" v-show="done">
    <div class="num-wrap">
    ...
    methods: {
      ...
      login() {
        ...
        this.$http.post('/v1/authentication/loginwechat?access_token=' + this.access_token, {
          wechatIdentity: 'oil',
          redirectUrl: this.$isTest ? 'http://test.m.cheyuu.com/html/carnumber/index.html' :
            'https://m.cheyuu.com/html/carnumber/index.html'
        }, this.baseUrl).then((data) => {
      ...
      getCarNumber() {
        this.$http.get('/v1/members/licenseplate?access_token=' + this.access_token, {}, this.baseUrl).then((data) => {
        ...
        this.$http.post('/v1/members/updatelicenseplatenumber?access_token=' + this.access_token, {
          ...
          if (data.error) {
            ...
            if (data.result == 1) {
              ...
              let url = this.$isTest ? 'http://test.m.cheyuu.com/account' : 'https://m.cheyuu.com/account';
              location.href = url
            } else {
              this.$vux.toast.show({
                type: 'warn',
