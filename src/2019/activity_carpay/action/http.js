        ...
        if (data.error.code === 401) { // token失效
          ...
          if (location.href.indexOf('?') !== -1) {
            ...
            if (allHrefParam.indexOf('&') !== -1) {
              contactID = (allHrefParam.split('&')[0]).split('=')[1]
              partnerID = (allHrefParam.split('&')[1]).split('=')[1]
              console.log(partnerID, contactID)
            }
          }
          ...
          axios({
            ...
            if (res.error) {
              ...
              localStorage.clear()
              location.href = isTest ? 'http://test.m.cheyuu.com/html/carpay/index.html#/?contactID=' + contactID + '&partnerID=' + partnerID + '&v=' + v : '//m.cheyuu.com/html/carpay/index.html#/?contactID=' + contactID + '&partnerID=' + partnerID + '&v=' + v
            } else {
