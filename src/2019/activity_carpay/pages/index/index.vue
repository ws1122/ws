<template>
  <div class="container" v-show="showPage">
    <div class="cheyoo-wrap" @click="toMyPoint">
  ...
  export default {
    ...
    methods: {
      ...
      createOrder() {
        ...
        this.$http.post('/v2/order/createcyborder?access_token=' + this.access_token, {
      ...
      login() {
        ...
        this.$http.post('/v1/authentication/loginwechat?access_token=' + this.access_token, {
          ...
          redirectUrl: this.$isTest ?
            `http://test.m.cheyuu.com/html/carpay/index.html#/?contactID=${this.contactID}&partnerID=${this.partnerID}&v=${v}` :
            `https://m.cheyuu.com/html/carpay/index.html#/?contactID=${this.contactID}&partnerID=${this.partnerID}`
        }, this.baseUrl).then((data) => {
      ...
      getuserinfo() {
        axios({
          ...
          if (Number(data.UID) > 0) {
            ...
            this.getDisTypeList()
            this.getMypoint()
            console.log(222, this.uiPromotionList)
          } else {
