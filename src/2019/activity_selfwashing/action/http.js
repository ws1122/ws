        ...
        if (data.error.code === 401) { // token失效
          ...
          if (location.href.indexOf('?') !== -1) {
            ...
            if (allHrefParam.indexOf('&') !== -1) {
              devcode = (allHrefParam.split('&')[0]).split('=')[1]
            }
          }
          ...
          axios({
            ...
            if (res.error) {
              ...
              localStorage.clear()
              location.href = isTest ? `http://test.m.cheyuu.com/html/selfwashing/index.html#/?devcode=${devcode}&v=${timestamp}` : `//m.cheyuu.com/html/selfwashing/index.html#/?devcode=${devcode}&v=${timestamp}`
            } else {
