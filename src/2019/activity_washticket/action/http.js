      ...
      if (data.error) {
        if (data.error.code === 401) { // token失效
          ...
          axios({
            ...
            let manageSign = getHref.getQuery('manageSign')
            let hrefRouter = getHref.getRouter()
            if (res.error) {
              ...
              localStorage.clear()
              if(hrefRouter === '#/record') {
                location.href = isTest? 'http://test.p.cheyuu.com/html/washticket/index.html#/record?manageSign=' + manageSign +'&v='+ v :
                'https://p.cheyuu.com/html/washticket/index.html#/record?manageSign=' + manageSign +'&v='+ v
              } else {
                location.href = isTest ? 'http://test.p.cheyuu.com/html/washticket/index.html#/?v=' + v : '//p.cheyuu.com/html/washticket/index.html#/?v=' + v
              }
            } else {
